...
public class GetUserFlickerImagListInteractorImpl implements IGetFlickrImageListInteractor {
    private Context context;
    private Callback callback;
    private SharepreferenceKeystore sharepreferenceKeystore;

    public GetUserFlickerImagListInteractorImpl(Context context) {
    ...
    public void getFlickerImageList(int pageNum, Callback callback) {
        ...
        String userFrob = sharepreferenceKeystore.get("flickr_frob");
        String userToken = sharepreferenceKeystore.get("flickr_user_token");
        String userId = sharepreferenceKeystore.get("flickr_user_id");
        ...
        String signatureText = AppConstant.FLICKR_SECRET
                ...
                + AppConstant.AUTH_TOKEN + userToken
                + AppConstant.FORMAT + AppConstant.JSON
                + AppConstant.METHOD + AppConstant.METHOD_GET_USER_IMAGE_LIST
        ...
        protected void onPostExecute(String result) {
            if(result != null) {
                try {
                    ...
                    sharepreferenceKeystore.putInt("user_total_page", obj.getJSONObject("photos").getInt("pages"));
